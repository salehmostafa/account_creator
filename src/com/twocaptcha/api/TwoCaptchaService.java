...
public class TwoCaptchaService {
	 ...
	 */
	public String solveCaptcha(boolean enableTimeOut) throws InterruptedException, IOException {
		...
		} while(hw.getHtml().contains("NOT_READY") && (!enableTimeOut || System.currentTimeMillis() - timeStarted < 200000));
		
		if(enableTimeOut && System.currentTimeMillis() - timeStarted >= 200000) {
			Logger.addMessage("Error - 2Captcha timed out after 200 seconds!");
			return null;
		}
